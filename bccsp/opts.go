...
// GMSM4ImportKeyOpts contains options for importing sm4 keys.
...
// GMSM2PrivateKeyImportOpts contains options for sm2 key importation from sm2.PrivateKey
...
// GMSM2PublicKeyImportOpts contains options for sm2 key importation from sm2.PublicKey
